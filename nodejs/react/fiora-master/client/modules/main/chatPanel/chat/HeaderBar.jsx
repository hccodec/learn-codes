...
import Feature from '@/modules/main/chatPanel/featureLinkmans/Feature.jsx';
import immutable from 'immutable';
import Sidebar from '@/modules/main/sidebar/Sidebar.jsx';
    ...
    render() {
        ...
        return (
            <div className="chat-headerBar">
                <IconButton width={40} height={40} icon="logout" iconSize={24} onClick={Sidebar.logout} />
                <h2>{linkmanName}</h2>
                {
                    isLogin ?
                        <div>
