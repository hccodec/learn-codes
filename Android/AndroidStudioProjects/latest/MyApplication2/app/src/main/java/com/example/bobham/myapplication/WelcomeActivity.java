...
public class WelcomeActivity extends BaseActivity {
    ...
    public void dialog() {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(dialog.getContext(),R.layout.support_simple_spinner_dropdown_item, languages);
        ...
        //若SharedPreferences已定义值，则直接跳转页面；否则弹出对话框选择语言
